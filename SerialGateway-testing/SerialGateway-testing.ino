...
#define RADIO_TX_LED_PIN    6  // the PCB, on board LED
#define MYScommand_LED      7  //  Indicate the dateway is sending a command
...
{ 
  ...
  gw.sleep(500);
  digitalWrite(MYScommand_LED, LOW);
  gw.sleep(500);  
  ...
  gw.sleep(500);
  digitalWrite(MYScommand_LED, HIGH);
  gw.sleep(500);
}
